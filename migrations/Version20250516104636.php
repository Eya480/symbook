 ...
 */
final class Version20250516104636 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE adresse ADD ville VARCHAR(255) NOT NULL, DROP ville_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE adresse ADD ville_id INT DEFAULT NULL, DROP ville');
